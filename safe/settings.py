...
SECRET_KEY = 'django-insecure-qe&pl-((b$g0$u5pa#rukybw!x@$liscsm)8rv()8(ed@fhego'
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/' # Arahkan ke rute root ('/') yang sudah kita definisikan sebagai Dashboard
LOGOUT_REDIRECT_URL = '/login/' # Arahkan kembali ke halaman login
